...
Find out how to create and organize your content quickly and intuitively in **hugo-blog** theme.
...
**hugo-blog** theme uses the summary of the content to display abstract information in the home page. Hugo can generate summaries of your content.
...
You may add the `<!--more-->` summary divider at the start of the article. Keep content that comes before the summary divider empty. Then **hugo-blog** theme will use your description as the summary.
...
**hugo-blog** theme has some extended syntax elements for you to write articles.
...
**hugo-blog** theme supports mathematical formulas based on [$ \KaTeX $](https://katex.org/).
...
{{< admonition info >}}
You can use the [`math` shortcode](../theme-documentation-extended-shortcodes/#14-math) to avoid [issues](https://github.com/akitectio/hugo-blog/issues/126) causing by special characters.
{{< /admonition >}}
...
An extended Markdown syntax for **ruby annotation** is supported in **hugo-blog** theme:
...
An extended Markdown syntax for **fraction** is supported in **hugo-blog** theme:
...
**hugo-blog** theme uses [Font Awesome](https://fontawesome.com/) as the icon library.
