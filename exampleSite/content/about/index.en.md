...
> [:(far fa-edit fa-fw): hugo-blog](https://github.com/akitectio/hugo-blog) is a **clean**, **elegant** but **advanced** blog theme for [Hugo](https://gohugo.io/) developed by [HEIGE-Trần Đức Duy](https://github.com/akitectio).
>
...
hugo-blog is licensed under the **MIT** license.

Check the [LICENSE file](https://github.com/akitectio/hugo-blog/blob/main/LICENSE) for details.
